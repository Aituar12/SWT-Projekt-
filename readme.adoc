image:https://github.com/st-tu-dresden-praktikum/swt23w13/workflows/CI%20build/badge.svg["CI Build", link="https://github.com/st-tu-dresden-praktikum/swt23w13/actions"]
...
The HotelWebsite module is a template project to bootstrap the Java project in the Software Engineering lab.
